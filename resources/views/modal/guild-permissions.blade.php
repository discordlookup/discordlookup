<div>
    <div
        x-cloak
        x-show="modalPermissionsOpen"
        x-trap.noscroll="modalPermissionsOpen"
        ...
        x-bind:aria-hidden="!modalPermissionsOpen"
        tabindex="-1"
        role="dialog"
    ...
    >
        <div
            x-cloak
            x-show="modalPermissionsOpen"
            @click.outside="modalPermissionsOpen = false"
            x-transition:enter="transition ease-out duration-200"
        ...
        >
            <div class="flex items-center justify-between px-5 py-4">
                <h3 class="text-xl font-medium"><span class="font-bold">{{ __('Permissions') }}</span>: {{ $guildName }}</h3>
            </div>
            <div class="grow p-5">
            ...
            <div class="space-x-1 px-5 py-4 text-right">
                <button
                    x-on:click="modalPermissionsOpen = false"
                    type="button"

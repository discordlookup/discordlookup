    ...
    <div class="p-5 lg:p-6 grow w-full">
        <div class="flex flex-col gap-y-5 md:gap-y-0.5 space-y-3 text-center">
            ...
            <div>
                ...
                <p>{!! __('This website is open source on :github.', ['github' => '<a href="' . config('app.github_url') . '" target="_blank" class="text-discord-blurple hover:text-[#4e5acb] active:text-[#414aa5]">GitHub</a>']) !!}</p>
            </div>

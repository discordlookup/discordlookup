...
<div>
    ...
    <div class="space-y-4">
        ...
        <x-link-card url="{{ route('webhook-invalidator') }}" icon="fas fa-link" title="{{ __('Discord Webhook Invalidator') }}" description="{{ __('Immediately delete a Discord webhook to elemenate evil webhooks.') }}" />
